...
WSGI_APPLICATION = 'seedteam.wsgi.application'
ASGI_APPLICATION = 'seedteam.asgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_CLASSES': [
        ...
        'common.throttles.LoginRateThrottle',
    ],
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'seedteam.log',
