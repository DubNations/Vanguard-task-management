    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('MEMBER', '普通成员'), ('LEADER', '组长'), ('ADMIN', '管理员')], default='MEMBER', max_length=10, verbose_name='角色')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leader', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='led_teams', to=settings.AUTH_USER_MODEL, verbose_name='组长')),
            ],
            options={
                'verbose_name': '团队',
